...
Router::scope('/', function (RouteBuilder $routes) {
    ...
    $routes->connect('/facts/code/', ['controller' => 'Pages', 'action' => 'factscode']);
	...
	$routes->connect('/api/brisbane-business-centres', ['controller' => 'Pages', 'action' => 'brisbaneBusinessCentres']);
	//$routes->connect('/api/scrape-startups', ['controller' => 'Pages', 'action' => 'scrapeStartups']);
	//$routes->connect('/api/scrape-investors', ['controller' => 'Pages', 'action' => 'scrapeInvestors']);
